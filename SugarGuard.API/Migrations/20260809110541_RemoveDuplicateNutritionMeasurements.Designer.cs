...
namespace SugarGuard.API.Migrations
{
    ...
    [Migration("20260809110541_RemoveDuplicateNutritionMeasurements")]
    partial class RemoveDuplicateNutritionMeasurements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SugarGuard.Domain.Entities.AiConversationMessage", b =>
                {
                    ...
                    b.Property<int?>("PrecachedPromptTokens")
                        .HasColumnType("integer")
                        .HasColumnName("precached_prompt_tokens");
            ...
            modelBuilder.Entity("SugarGuard.Domain.Entities.DoctorVerificationDocument", b =>
                {
                    ...
                    b.ToTable("doctor_verification_documents");
                });

            modelBuilder.Entity("SugarGuard.Domain.Entities.DoctorVerificationRequest", b =>
                {
                    b.Property<Guid>("RequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("EncryptedLicenseNumber")
                        ...
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("encrypted_license_number");
                    ...
                    b.ToTable("doctor_verification_requests");
                });
            ...
            modelBuilder.Entity("SugarGuard.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("DailySummaryEnabled")
                        ...
                        .HasColumnName("daily_summary_enabled");
            ...
            modelBuilder.Entity("SugarGuard.Domain.Entities.DoctorVerificationDocument", b =>
                {
                    b.HasOne("SugarGuard.Domain.Entities.DoctorVerificationRequest", "Request")
                        .WithMany("Documents")
