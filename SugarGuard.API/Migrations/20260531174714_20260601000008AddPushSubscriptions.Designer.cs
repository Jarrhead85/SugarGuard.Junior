...
namespace SugarGuard.API.Migrations
{
    ...
    [Migration("20260531174714_20260601000008AddPushSubscriptions")]
    partial class _20260601000008AddPushSubscriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SugarGuard.Domain.Entities.VerificationCode", b =>
                {
                    b.Property<Guid>("CodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CodeHash")
                        .HasDatabaseName("ix_verificationcodes_codehash");

                    b.HasIndex("UserId", "Type", "ExpiresAt")
                        .HasDatabaseName("ix_verificationcodes_user_type_expires");
