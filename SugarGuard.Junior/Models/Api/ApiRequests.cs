...
public class RecommendationRequest
{
    ...
    /// <summary>
    /// Сохраняется для совместимости со старыми версиями API.
    /// Сервер всегда формирует рекомендацию по свежему контексту и не использует
    /// прикладной кэш предыдущих советов.
    /// </summary>
